import { Link2, SlidersVertical, ShieldCheck, MonitorSmartphone } from 'lucide-react';
...
export default function KeyFeature() {
    ...
    return (
        <section className="mx-[16px] lg:mx-[120px]">
            <div>
                <h2 className='text-center font-bold text-[27px]'>Key Features</h2>
                <p className='text-center font-normal text-[14px]'>Explore the powerful features that make Edibo the easiest way to vote online.</p>
                <div className='mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:grid-rows-2'>
                    <div className='bg-featurebg rounded-[20px] flex flex-col gap-[10px] h-[205px] px-[20px] py-[45px] lg:col-start-1 lg:row-start-1'>
                        ...
                        <p className='text-[14px] text-left'>Send a single link to your voters — no account, no app download needed. Just click and vote.</p>
                    </div>
                    <div className='bg-featurebg rounded-[20px] flex flex-col gap-[10px] h-[205px] px-[20px] py-[45px] lg:col-start-3 lg:row-start-1'>
                        <div className='flex flex-row items-center gap-x-2'>
                            ...
                            <p className='font-bold text-[16px]'>Easy Setup & Customization</p>
                        </div>
                        <p className='text-[14px] text-left'>Create polls or elections in minutes with customizable options tailored to your needs.</p>
                    </div>
                    ...
                    <div className='bg-featurebg rounded-[20px] flex flex-col gap-[10px] h-[205px] px-[20px] py-[45px] lg:col-start-1 lg:row-start-2'>
                        ...
                        <p className='text-[14px] text-left'>Every vote is protected with encryption, and voter identities remain completely private.</p>
                    </div>
                    <div className='bg-featurebg rounded-[20px] flex flex-col gap-[10px] h-[205px] px-[20px] py-[45px] lg:col-start-3 lg:row-start-2'>
                        ...
                        <p className='text-[14px] text-left'>Edibo works seamlessly on phones, tablets, and desktops — so everyone can vote from anywhere.</p>
                    </div>
                </div>
