            ...
            />
              ...
              everyone can vote from anywhere."
                    ...
                    <FeatureCard
                        ...
                        text="Assign different roles like admin, creator, or voter to manage permissions and maintain organized voting workflows."
                    />

                    <FeatureCard
                        Icon={<Clock />}
                        header="Vote Scheduling"
                        text="Set start and end times for your polls or elections so voting runs automatically — even when you're offline."
                    />
                </div>
            </div>
        </section>
