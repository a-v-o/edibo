  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-20 overflow-hidden">
      <div className="flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-2 font-bold text-5xl leading-none">
      ...
      <div className="scale-[85%] md:scale-100 relative flex items-end w-full aspect-[4/5] bg-linear-180 from-[#017648] to-[#033824] rounded-3xl p-16">
        ...
        <div className="flex items-center backdrop-blur-lg shadow-lg w-[55%] md:w-1/2 min-h-[120px] p-3 rounded-4xl absolute top-12 -left-8 bg-linear-180 from-[#D0FFED80] to-[#017648B8] ">
        ...
        <Image
          ...
          width={500}
          height={500}
          className="w-full h-auto animate-[bounce_2.5s_infinite]"
        />
      </div>
    </div>
  );
